...
if __name__ == "__main__":
    print(lemmatize("The increase of the working range consists in improving the homogeneity of the RF magnetic field generated by the coil. Further, the results of the numerical modeling of the structure are presented; these results indicate significant improvement of the magnetic field homogeneity in the selected area. In this connection, we can refer to, e.g., the static magnetic field strength and homogeneity, the excitation RF magnetic field strength and homogeneity, the quality factor of the resonator, or the resonator field filling factor."))
    a = 0
